...
class __TwigTemplate_edce41a06da277843e476a2c1ffbd1a2345cfd2fd41810af56f4069185ee0ac8 extends \Twig\Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("TwigBundle:Exception:traces.html.twig", "TwigBundle:Exception:exception.html.twig", 38)->display(twig_to_array(["exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))]));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 64)->display(twig_to_array(["logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", [])]));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("TwigBundle:Exception:traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 89)->display(twig_to_array(["exception" => ($context["exception"] ?? $this->getContext($context, "exception"))]));
        // line 90
        echo "
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/Users/vladanjovic/workspace/restish/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
